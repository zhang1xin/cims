    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                ...
                <form class="form-inline" role="form" action="${pageContext.request.contextPath}/subsidy.do" method="post">
                            ...
                            <section class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="sdate" class="form-control" placeholder="请输入开始日期"
                                               readonly>
                                    </div>
